...
# Firebase setup
cred = credentials.Certificate("botdatabase-9176f-firebase-adminsdk-19zwj-bf650593e5.json")
...
# Main function
def main():
    application = Application.builder().token("7950655078:AAG4hS6PVCGjNf8hFMirGovLyz5InvTRlzQ").build()
